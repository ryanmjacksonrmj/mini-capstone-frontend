  ...
  return (
    <div>
      ...
      <div>
        ...
        <div key={product.id}>
          <button className="text-left index-card-target flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100" onClick={() => props.onShowProduct(product)}>
          <img
          ...
          <div>
            ...
            <input type="text" id="quantity-input" data-input-counter aria-describedby="helper-text-explanation" className="bg-gray-50 border-x-0 border-gray-300 h-11 text-center text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full py-2.5" placeholder="1" required />
